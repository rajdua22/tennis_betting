...
an output file with predictions for 2014+. Uses entire feature set.
"""
...
betting.to_csv('Predictions(Log_Reg).csv')
...
data.to_csv('Data_and_predictions(Log_Reg).csv')
...
betting2.to_csv('PredictionsTest(Log_Reg).csv')
