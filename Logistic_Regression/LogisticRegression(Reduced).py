...
an output file with predictions for 2014+. Uses reduced feature set.
"""
...
X = data[['WRank', 'LRank', 'winner_hand', 'winner_ht', 'winner_age',
          'loser_hand',  'loser_age', 'oddsw', 'oddsl',
...
coef_df.to_csv('LogRegCoef2.csv')
...
betting.to_csv('Predictions(Log_Reg)2.csv')
...
data.to_csv('Data_and_predictions(Log_Reg)2.csv')


X_test2 = dataLate[['WRank', 'LRank', 'winner_hand', 'winner_ht', 'winner_age',
          'loser_hand',  'loser_age', 'oddsw', 'oddsl',
          'Wcomb', 'Lcomb', 'POSW', 'POSL', 'PINW',
          'PINL', 'DSWW', 'DSLW', 'FSIW',
          'BPFGW', 'DSWL', 'DSLL',
...
betting2.to_csv('PredictionsTest(Log_Reg)2.csv')
